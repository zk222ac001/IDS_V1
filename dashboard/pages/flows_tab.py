...
def render(flows_df: pd.DataFrame, tab_container) -> None:
    ...
    with tab_container:
        ...
        with st.sidebar:
            ...
            selected_protocol = st.selectbox("🧭 Protocol", protocols, key="protocol_select")
            ...
            min_packets = st.slider("📊 Min Packets", 0, slider_max, 0, key="min_packets")

            refresh_toggle = st.checkbox("🔁 Auto-refresh every 30s", value=False, key="auto_refresh")
        ...
        with tab1:
            ...
            st.download_button("📥 Download Filtered Flows", csv_text, file_name="flows.csv", mime="text/csv")
        ...
        with tab2:
            ...
            use_cluster = st.checkbox("📊 Enable 3D Clustering", value=False, key="cluster")
            use_heatmap = st.checkbox("🔥 Enable Heatmap View", value=False, key="heatmap")
